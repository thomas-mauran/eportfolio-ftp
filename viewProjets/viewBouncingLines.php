...
<body>
    ...
    <div class = "container">
        <div class = "box">
            <div class = "texte">
                <div class = "titre">
                    <h1>Bouncing lines website background</h1>
                </div>
                <div class = "description">
                    ...
                    <p>
                        ...
                        Recharger la page permet de générer de nouvelles lignes. 
                    </p>
        ...
        <div class = "box" id="boxImage">
            ...
            <script> 
                ...
                // Liste d'images
                imageList[0] = '../images/bouncingLines.png'
                imageList[1] = '../images/bouncingLines2.png'
                imageList[2] = '../images/bouncingLines3.png'
            ...
            <div class ="line">
                <div class = "liens">
                    <a target="_blank" rel="noopener noreferrer" href="https://github.com/thomas-mauran/bouncingLines"><img class="imgLiens" src="/images/logoGithub.png" alt="logo github"></a>
                    <p>Lien github</p>

                </div>

                <div class = "liens">
                    <a target="_blank" rel="noopener noreferrer" href="https://thomasprojects.works/projetsFiles/bouncingLines/"><img class="imgLiens" src="/images/liveCode.png" alt="logo live code"></a>
                    <p>Lien live</p>
